// 🎨 danmu-color-args.js
// Author: Yu9191
// Modified for custom domain: dm.87445211.xyz
...
// === 弹幕接口模式 ===
// 【重要修改】这里将原来的 dm.yiya.love 改为自建域名 dm.87445211.xyz
if ($response && $request && /^https:\/\/dm\.87445211\.xyz\/\d+\/api\/v2\/comment\//.test($request.url)) {
  try {
    const cfg = getConfig();
